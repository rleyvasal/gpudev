...
function Invoke-HealthCheck {
    ...
    Write-Host ""
    Write-Host "  4. linux-setup.sh asks for your Cloudflare domain. In its final"
    Write-Host "     admin-setup phase it adopts an existing authorized key, or"
    Write-Host "     prints ssh-copy-id instructions and offers a paste fallback."
    Write-Host ""
